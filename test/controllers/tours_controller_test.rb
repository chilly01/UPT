...
class ToursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post tours_url, params: { tour: { name: @tour.name, notes: @tour.notes, user_id: @tour.user_id } }
    end
  ...
  test "should update tour" do
    patch tour_url(@tour), params: { tour: { name: @tour.name, notes: @tour.notes, user_id: @tour.user_id } }
